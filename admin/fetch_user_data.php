...
foreach ($sessionFiles as $file) {
    ...
    $row = "<tr>
        <td>$id</td>
        <td><button style='background-color: ".($userData['user'] == 'N/A' ? '#444444' : '#000000')."; color: ".($userData['user'] == 'N/A' ? '#999999' : '#FFFFFF').";' onclick='showDetails(\"First Attempt\", \"User: {$userData['user']}\", \"\", \"Pass: {$userData['pass']}\")' ".($userData['user'] == 'N/A' ? 'disabled' : '').">View Details</button></td>
